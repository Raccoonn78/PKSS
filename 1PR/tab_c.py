...
class Example(tk.Frame):
    ...
    def on_click(self):
        ...
        result=''
        if (a>3 and a<15):
            result=result+'A принадлежит интервалу'
        if (b>3 and b<15):
            result=result+'B принадлежит интервалу'
        if (c>3 and c<15):
            result=result+'C принадлежит интервалу'
        if (d>3 and d<15):
            result=result+'D принадлежит интервалу'

        if result=='':
            result='ни одно число не принадлжеит интервалу'
